<p align="center">
    ...
    <h2 align="center">Rosé Pine Icon Theme</h2>
</p>
...
2. Copy your favorite theme folder into the icons directory
3. Paste them into the .icons folder in your home folder
4. Apply the theme in appearance settings (other desktops) or in gnome-tweaks (Gnome)
